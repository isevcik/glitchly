...
{
	if (region.a7.aw === region.bp.aw)
	{
		return 'on line ' + region.a7.aw;
	}
	return 'on lines ' + region.a7.aw + ' through ' + region.bp.aw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b2: 'hidden', bY: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b2: 'mozHidden', bY: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b2: 'msHidden', bY: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b2: 'webkitHidden', bY: 'webkitvisibilitychange' }
		: { b2: 'hidden', bY: 'visibilitychange' };
}
...
var author$project$Main$Glitch = F5(
	function (color, angle, offset, duration, delay) {
		return {aY: angle, a_: color, bn: delay, bo: duration, aN: offset};
	});
var author$project$Main$Model = F4(
	function (text, glitch1, glitch2, glitch) {
		return {bt: glitch, as: glitch1, at: glitch2, aU: text};
	});
var author$project$Main$initText = 'Glitch Effect Generator';
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A4(
			...
			author$project$Main$initText,
			A5(author$project$Main$Glitch, '#ecf', 45, 50, 2, 0),
			A5(author$project$Main$Glitch, '#2fc', 180, 50, 3, 500),
			A5(author$project$Main$Glitch, '#000', 0, 0, 0, 0)),
		elm$core$Platform$Cmd$none);
};
var author$project$Main$setOffset = F2(
	function (offset, glitch) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							as: A2(author$project$Main$setOffset, v, model.as)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var v = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							at: A2(author$project$Main$setOffset, v, model.at)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$Slider1 = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$Slider2 = function (a) {
	return {$: 2, a: a};
};
...
var rtfeldman$elm_css$Css$zero = {av: 0, _: 0, A: 0, aa: 0, ab: 0, I: 0, J: 0, ax: 0, D: 0, aP: 0, ak: '', aF: 0, u: '0'};
...
var rtfeldman$elm_css$Css$Animations$keyframes = function (tuples) {
	return elm$core$List$isEmpty(tuples) ? {a1: 0, a3: 0, u: 'none'} : {
		a1: 0,
		a3: 0,
		u: rtfeldman$elm_css$Css$Internal$compileKeyframes(tuples)
	};
};
...
var author$project$Main$glitchAnim = function (def) {
	var y = (def.aN / 100) * elm$core$Basics$sin(
		elm$core$Basics$degrees(def.aY));
	var x = (def.aN / 100) * elm$core$Basics$cos(
		elm$core$Basics$degrees(def.aY));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3(rtfeldman$elm_css$Css$translate3d, rtfeldman$elm_css$Css$zero, rtfeldman$elm_css$Css$zero, rtfeldman$elm_css$Css$zero)
							]))
					])),
				_Utils_Tuple2(
				25,
...
var rtfeldman$elm_css$Css$absolute = {ay: 0, u: 'absolute'};
...
var rtfeldman$elm_css$Css$animationName = function (arg) {
	return ((arg.u === 'none') || ((arg.u === 'inherit') || ((arg.u === 'unset') || (arg.u === 'initial')))) ? A2(rtfeldman$elm_css$Css$prop1, 'animation-name', arg) : rtfeldman$elm_css$Css$Preprocess$WithKeyframes(arg.u);
};
...
var rtfeldman$elm_css$Css$ms = function (amount) {
	return {
		bo: 0,
		u: elm$core$String$fromFloat(amount) + 'ms'
	};
};
var rtfeldman$elm_css$Css$position = rtfeldman$elm_css$Css$prop1('position');
var rtfeldman$elm_css$Css$PxUnits = 0;
var rtfeldman$elm_css$Css$px = A2(rtfeldman$elm_css$Css$Internal$lengthConverter, 0, 'px');
var rtfeldman$elm_css$Css$relative = {ay: 0, u: 'relative'};
var rtfeldman$elm_css$Css$sec = function (amount) {
	return {
		bo: 0,
		u: elm$core$String$fromFloat(amount) + 's'
	};
};
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bl: elm$core$Maybe$Nothing, bv: _List_Nil, bB: _List_Nil, bN: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	...
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bl: charset, b_: declarations, bv: imports, bB: namespaces};
};
	...
	function (declaration, _n0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return elm$core$String$isEmpty(record.bZ) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3(elm$core$Dict$insert, record.b8, record.bZ, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bl: charset, b_: finalDeclarations, bv: imports, bB: namespaces};
};
...
var author$project$Main$glitchView = F3(
	function (text, childs, def) {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$core$List$isEmpty(childs) ? rtfeldman$elm_css$Css$absolute : rtfeldman$elm_css$Css$relative),
							rtfeldman$elm_css$Css$top(
							rtfeldman$elm_css$Css$px(0)),
							rtfeldman$elm_css$Css$left(
							rtfeldman$elm_css$Css$px(0)),
							rtfeldman$elm_css$Css$zIndex(
							elm$core$List$isEmpty(childs) ? rtfeldman$elm_css$Css$int(-1) : rtfeldman$elm_css$Css$int(0)),
							...
							rtfeldman$elm_css$Css$hex(def.a_)),
							rtfeldman$elm_css$Css$textAlign(rtfeldman$elm_css$Css$center),
							rtfeldman$elm_css$Css$animationName(
							author$project$Main$glitchAnim(def)),
							rtfeldman$elm_css$Css$animationDuration(
							rtfeldman$elm_css$Css$sec(def.bo)),
							rtfeldman$elm_css$Css$animationDelay(
							rtfeldman$elm_css$Css$ms(def.bn)),
...
var author$project$Main$onChangeDecoder = A2(
...
var rtfeldman$elm_css$Css$none = {Q: 0, bh: 0, m: 0, a: 0, f: 0, b3: 0, bx: 0, a1: 0, ab: 0, I: 0, s: 0, c: 0, b: 0, a3: 0, aP: 0, cc: 0, q: 0, aQ: 0, ce: 0, ah: 0, O: 0, o: 0, e: 0, cj: 0, u: 'none'};
...
var author$project$Main$sliderView = F2(
	function (def, slider) {
		return A2(
			...
			_List_fromArray(
				[
					...
					'input',
					A2(elm$json$Json$Decode$map, slider, author$project$Main$onChangeDecoder))
				]),
			_List_Nil);
	});
...
var rtfeldman$elm_css$Css$row = {a0: 0, ar: 0, u: 'row'};
...
var rtfeldman$elm_css$Css$wrap = {ar: 0, aJ: 0, u: 'wrap'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(
						author$project$Main$glitchView,
						model.aU,
						A2(
							elm$core$List$map,
							A2(author$project$Main$glitchView, model.aU, _List_Nil),
							_List_fromArray(
								[model.as, model.at])),
						model.bt)
					])),
				...
				_List_fromArray(
					[
						A2(author$project$Main$sliderView, model.as, author$project$Main$Slider1),
						A2(author$project$Main$sliderView, model.at, author$project$Main$Slider2)
					]))
			]));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bs: fragment, bu: host, bC: path, bE: port_, bH: protocol, bI: query};
	});
